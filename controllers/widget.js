 ...
 * @summary com.mdpauley.weather-icons
 * @version 1.2.0
 * @desc Font Awesome Ti.Widget
 * @example <caption>Alloy:</caption>
 * <Widget id = "fa" src = "com.mdpauley.weather-icons" />
 * @example <caption>Titanium:</caption>
 * var fa = Alloy.createWidget("com.mdpauley.weather-icons");
 * win.add(fa);
 */
 ...
 * 
 * @example <caption>Titanium:</caption>
 *	var glyph = Alloy.createWidget("com.mdpauley.weather-icons");
 *	var glyphicons = require('glyphicons');
 * 	glyph.icons = MyIconFile;
 * 	win.add(glyph);
 * @example <caption>Alloy:</caption>
 *  <Widget id = "fa" src = "com.mdpauley.weather-icons" icons = "require('glyphicons')" />
 * 	
 */
exports.icons;
 ...
 * 
 * @example <caption>Alloy:</caption>
 *  <Widget src = "com.mdpauley.weather-icons" iconPrefix = "glyph-" />
 ...
 *	<Alloy>
 *		<Window id = "index">
 *			<Label id = "MyLabel" icon="wi-star"></Label>
 *			<Button id = "MyButton" icon="wi-file"></Button>
 *			<Widget id="fa" src = "com.mdpauley.weather-icons" instaParse = "false" />
 *		<Window>
 *	</Alloy>
 ...
 * @param {String} icon - Change existing icon property to (e.g. : "wi-flag")
 * 
 * @desc 
 * Changes an already existing Icon to another Icon on an existing view element.
 * 
 * @example $.wi.change(MyLabel, "wi-flag")  
 */
 ...
 * that only have the proper prefix (default 'wi-'), then apply icons respectivly. 
 * 
 ...
 * apply icons to any item with 'icon' property containing 'wi-' prefix.
 */
function applyIcons() {
        ...
        if (children) {
            children.forEach(function (tag) {
                ...
                if (tag['icon']) {
                    ...
                    //Only handle icons that use 'wi-' prefix					
                    if (tag['icon'].substring(0, 3) === "wi-") {
                        
                        if (debugMode) Ti.API.debug('['+counter+'] ('+tag['id']+')  wi- prefix found');
 ...
 * 
 * @param {Ti.UI.View} el - Create and Prepend To Target Element (label, button, view, etc)
 * @param {String} iconName - font-awesome icon string (ie: wi-flag)
 */
...
if (typeof iconPrefix 	=== 'undefined') { iconPrefix = 'wi-'; }
